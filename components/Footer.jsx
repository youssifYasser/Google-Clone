...
const Footer = () => {
  ...
  return (
    <footer className='grid w-full divide-y-[1px] divide-gray-300 dark:divide-[#3b3b3b] bg-gray-100 dark:bg-black text-sm text-gray-500 dark:text-gray-400'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 px-8 py-3 grid-flow-row-dense'>
        <div className='flex items-center justify-center md:col-span-2 lg:col-span-1 lg:col-start-2'>
          <GlobeAltIcon className='h-5 mr-1 text-green-700 dark:text-green-600' />{' '}
